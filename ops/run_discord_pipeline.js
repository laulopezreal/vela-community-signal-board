...
const { hash, fingerprint, findPrimaryDimension } = require('../server/lib/scoring/rubric');
const { parseExport, normalizeMessage, clusterDedupe } = require('../server/lib/scoring/normalize');
